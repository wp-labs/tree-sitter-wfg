...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_scenario_attributes] = STATE(63),
    [sym_scenario_declaration] = STATE(158),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [27] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_injection_block_repeat1, 2, 0, 0),
  [29] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_injection_block_repeat1, 2, 0, 0), SHIFT_REPEAT(109),
  [32] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_expect_block_repeat1, 2, 0, 0),
  [34] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expect_block_repeat1, 2, 0, 0), SHIFT_REPEAT(97),
  ...
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_timeline_expression_repeat1, 2, 0, 0),
  [80] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_timeline_expression_repeat1, 2, 0, 0), SHIFT_REPEAT(89),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expect_statement, 6, 0, 6),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_annotation_list, 2, 0, 0),
  [87] = {.entry = {.count = 1, .reusable = true}}, SHIFT(56),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_traffic_block_repeat1, 2, 0, 0),
  [91] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_traffic_block_repeat1, 2, 0, 0), SHIFT_REPEAT(120),
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_injection_case, 8, 0, 7),
  ...
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_annotation_list, 1, 0, 0),
  [106] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sequence_block_repeat1, 2, 0, 0), SHIFT_REPEAT(116),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sequence_block_repeat1, 2, 0, 0),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_annotation_list_repeat1, 2, 0, 0),
  [113] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_annotation_list_repeat1, 2, 0, 0), SHIFT_REPEAT(56),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_annotation_item, 3, 0, 2),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_traffic_block, 4, 0, 0),
  [120] = {.entry = {.count = 1, .reusable = true}}, SHIFT(51),
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_predicate_list, 2, 0, 0),
  [124] = {.entry = {.count = 1, .reusable = true}}, SHIFT(152),
  [126] = {.entry = {.count = 1, .reusable = true}}, SHIFT(74),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_predicate_list, 1, 0, 0),
  [130] = {.entry = {.count = 1, .reusable = true}}, SHIFT(117),
  [132] = {.entry = {.count = 1, .reusable = true}}, SHIFT(125),
  [134] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_predicate_list_repeat1, 2, 0, 0), SHIFT_REPEAT(51),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_predicate_list_repeat1, 2, 0, 0),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_traffic_block, 3, 0, 0),
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_declaration, 2, 0, 1),
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_value, 1, 0, 0),
  [145] = {.entry = {.count = 1, .reusable = true}}, SHIFT(135),
  [147] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_timeline_expression, 4, 0, 0),
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_timeline_segment, 5, 0, 8),
  [151] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_wave_expression, 14, 0, 10),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_predicate, 3, 0, 2),
  [155] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_injection_block, 3, 0, 0),
  ...
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_burst_expression, 18, 0, 13),
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_timeline_expression, 3, 0, 0),
  [167] = {.entry = {.count = 1, .reusable = true}}, SHIFT(44),
  [169] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_statement, 10, 0, 11),
  [173] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_wave_expression, 18, 0, 12),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_injection_block, 4, 0, 0),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rate_expression, 1, 0, 0),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stream_statement, 4, 0, 5),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scenario_declaration, 10, 0, 4),
  ...
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expect_block, 4, 0, 0),
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scenario_declaration, 9, 0, 4),
  ...
  [219] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scenario_declaration, 8, 0, 4),
  [221] = {.entry = {.count = 1, .reusable = true}}, SHIFT(95),
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scenario_declaration, 7, 0, 3),
  ...
  [237] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expect_function, 1, 0, 0),
  [239] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expect_block, 3, 0, 0),
  ...
  [261] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mode_keyword, 1, 0, 0),
  ...
  [275] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scenario_declaration, 6, 0, 3),
  ...
  [283] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sequence_block, 5, 0, 9),
  ...
  [303] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scenario_declaration, 5, 0, 3),
  ...
  [321] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scenario_attributes, 3, 0, 0),
  ...
  [349] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_wave_shape, 1, 0, 0),
